...
os.environ['SAMBANOVA_API_KEY'] = 'YOUR_SAMBANOVA_API_KEY taken from https://cloud.sambanova.ai/apis' ### 
...
def llama3_analyze(prompt):
    try:
        ...
        print(f"Error in Llama3 analysis: {str(e)}")
        return None
...
def generate_markmap_mindmap(paper_content, first_pass_summary, second_pass_summary, third_pass_summary, high_level_summary):
    ...
    """
    markmap_content = llama3_analyze(prompt)
...
def main():
    ...
    file_path = 'papers/2410.10934v1__Agent-as-a-Judge__Evaluate Agents with Agents.pdf'
    human_prompt = ''
